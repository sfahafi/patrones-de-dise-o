...
public class Cpu {
    ...
    private boolean voltajeOk, energiaDispositivosOk, contadoresOk, biosOk,
                    hardwareOk, entradasOk, sectorArranqueOk, bootOk, soOk,
                    listoOk;

    public Cpu() {
    }
    
    public boolean enviaVoltaje(int voltaje){
        if(voltaje>=200 && voltaje<=240){
            voltajeOk=true;
        }
        return voltajeOk;
    }
